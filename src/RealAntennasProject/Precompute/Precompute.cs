...
namespace RealAntennas.Precompute
{
    ...
    internal class Precompute
    {
        ...
        public NativeList<AntennaData> antennaDataList = new NativeList<AntennaData>(Allocator.Persistent); public NativeList<int4> allAntennaPairs = new NativeList<int4>(Allocator.Persistent);
