...
namespace RealAntennas.UpgradeScripts
{
    ...
    public class v2_5_AntennaState : UpgradeScript
    {
        ...
        public override Version TargetVersion => new Version(2, 5, 0);
    ...
    public class v2_5_AntennaState_KCTBase : v2_5_AntennaState
    {
